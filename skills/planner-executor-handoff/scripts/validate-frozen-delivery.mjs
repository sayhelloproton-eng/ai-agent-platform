...
if (!["apply_frozen_artifacts", "continuation"].includes(data.execution_mode)) {
...
if (data.skill_policy?.planner_executor_handoff !== "full") errors.push("planner_executor_handoff skill policy must be full");
if (!["contract_reference_only", "not_required"].includes(data.skill_policy?.project_knowledge_governance)) errors.push("invalid project_knowledge_governance skill policy");
