...
Working Branch:
  ...
  Last Verified Review Source: da818cad26a87afc0a4dc8cee3f251c2d1ca4bb8
...
当前视觉资产 Registry 扩展到 34 个 ID。`VIS-028 v2` 与 `VIS-029 v2` 使用用户已确认的正式 PNG：VIS-028 保留总体架构与执行路径构图并补入 DDD 限界上下文映射，VIS-029 沿用此前确认的分阶段 MVP 路线图；包内 SVG 仅作为可编辑参考。旧 `VIS-001`、`VIS-003`～`VIS-009` 转入平台架构历史 Document Bundle，保留语义但不再作为当前架构入口。
...
- 当前主线进入 `06_智能体资产体系` 正式内容人工 Review；
...
1. 开始 `docs/knowledge/06_智能体资产体系/` 人工 Review；
