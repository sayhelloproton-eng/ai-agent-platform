# Historical Asset Inventory — 2026-07-26
...
`docs/08-research/external/waytoagi-feishu-cli-export/` 包含：
...
- 本地文件不删除；
- `docs/08-research/external/waytoagi-feishu-cli-export.zip` 不提交。

## 图片与大文件

| 路径 | 大小 | 结论 |
|---|---:|---|
| `docs/02-architecture/diagrams/platform-target-architecture-v1.png` | 约 1.6 MB | 项目自产架构图，可提交 |
| `docs/08-research/external/waytoagi-feishu-cli-export.zip` | 约 399 KB | 第三方镜像压缩包，不提交 |
