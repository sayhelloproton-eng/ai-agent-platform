...
![知识生命周期与单向投影](asset://05_上下文与知识系统/KNO-005-项目知识生命周期/VIS-010-知识生命周期与单向投影.png)

- Visual Asset ID：`VIS-010`；
- SVG 源文件：`knowledge-assets:images/05_上下文与知识系统/KNO-005-项目知识生命周期/VIS-010-知识生命周期与单向投影.svg`；
- PNG 预览：`knowledge-assets:images/05_上下文与知识系统/KNO-005-项目知识生命周期/VIS-010-知识生命周期与单向投影.png`；
...
- [ADR-002 Git 单一真源](../../../docs/adr/ADR-002-git-single-source-feishu-projection.md)
