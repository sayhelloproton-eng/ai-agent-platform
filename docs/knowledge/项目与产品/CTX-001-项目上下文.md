...
canonical_path: docs/knowledge/项目与产品/CTX-001-项目上下文.md
...
`ai-agent-platform` 是面向学习、工程实践和求职作品集的长期 AI Agent 工程平台。项目通过可验证的知识资产、任务契约、Agent 协作和 Workflow，逐步构建模型、工具、设备与 Provider 可替换的智能应用基础。
...
- 作品集能展示可运行 Demo、工程质量、架构判断、实验与量化验证。

## 关联资产

- [CTX-002 Current State](../../technical/Archive/历史Context/CTX-002-current-state.md)
- [CTX-003 项目总览](./CTX-003-项目总览.md)
- [CTX-004 六个月路线图](../../technical/Archive/历史Context/CTX-004-roadmap-6-months.md)
- [PRD-001 平台愿景](./PRD-001-平台愿景.md)
- [ARC-001 平台目标架构](../架构与领域/平台架构/ARC-001-平台目标架构.md)
- [ADR-002 Git Single Source of Truth](../../adr/ADR-002-git-single-source-feishu-projection.md)
