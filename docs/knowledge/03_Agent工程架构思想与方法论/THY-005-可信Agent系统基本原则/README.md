...
- [历史设计输入：ARC-013 审批、证据与副作用账本、ARC-014 健康与恢复治理](../../../technical/归档/历史资产/04_平台架构_整合前观点与后续处理候选/README.md)
- [WFL-009 当前审批、权限校验与副作用治理](../../07_工作流与项目治理/WFL-009-审批权限校验与副作用治理/README.md)
- [WFL-007 当前任务状态、Checkpoint、移交与恢复](../../07_工作流与项目治理/WFL-007-任务状态Checkpoint移交与恢复/README.md)
