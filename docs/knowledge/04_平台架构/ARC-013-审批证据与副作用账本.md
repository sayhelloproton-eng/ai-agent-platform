...
![审批、证据与副作用账本](asset://04_平台架构/ARC-013-审批证据与副作用账本/VIS-007-审批证据与副作用账本.png)

- Visual Asset ID：`VIS-007`；
- SVG 源文件：`knowledge-assets:images/04_平台架构/ARC-013-审批证据与副作用账本/VIS-007-审批证据与副作用账本.svg`；
- PNG 预览：`knowledge-assets:images/04_平台架构/ARC-013-审批证据与副作用账本/VIS-007-审批证据与副作用账本.png`；
